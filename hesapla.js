...
if(vize1 == "100"){alert("OOO TEBRİKLER :D");}
if(vize1 != "")
{
text = text + "<br><br><br>";
				...
				{
				text = text + "Finalden " + mfn + " alırsan, ortalamalan " + (+mfn*6/10 + (+vize1)*4/10) +" olur." + "<br>";
				}
				...
				for(mfn = 0;mfn<=100;mfn++)
				{
				text = text + "Finalden " + mfn + " alırsan, ortalamalan " + (+mfn*6/10 + (+vizeOrt)*4/10) +" olur." + "<br>";
				}
				document.getElementById("final").innerHTML = text;
				}
				}
				else{alert("Sayı giriniz");}
}
else
{
alert("1. vize bo? bırakılamaz.");
}
}
